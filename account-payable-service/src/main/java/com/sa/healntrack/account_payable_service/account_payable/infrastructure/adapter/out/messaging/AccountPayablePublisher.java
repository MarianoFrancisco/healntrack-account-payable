...
import com.sa.healntrack.account_payable_service.account_payable.infrastructure.adapter.out.messaging.mapper.AccountPayableOutMessagingMapper;
...
public class AccountPayablePublisher implements PublishAccountPayableClosed {
    ...
    private final AccountPayableOutMessagingMapper mapper;
